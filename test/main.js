...
describe('html-autoprefixer', function() {
  describe('#process', function() {
    ...
    it('autoprefixes inside of style attributes', function() {
      ...
      var prefixedResult = '<html><h1 style=\"-webkit-transition: -webkit-transform 1s;transition: transform 1s\">Hello</h1><h2 style=\"display: -webkit-box;display: -webkit-flex;display: -ms-flexbox;display: flex\">World</h2></html>';
